...
const Footer = () => {
  ...
  const socialLinks: ReactNode[] = [
    <Facebook
      key="f"
      href="https://www.facebook.com/ManhHoDinh.03/"
      className="social-link"
    />,
    <Instagram
      key="i"
      href="https://www.instagram.com/ManhHoDinh.03/"
      className="social-link"
    />,
    <Github
      key="g"
      href="https://github.com/ManhHoDinh"
      className="social-link"
    />,
    <Youtube
      key="y"
      href="https://www.youtube.com/@ManhHoDinh"
      className="social-link"
    />,
  ];
  return (
    <footer className="pt-20 pb-4">
      ...
      <div className="container mb-12 flex flex-col lg:flex-row">
        <div className="basis-1/3 flex flex-col md:items-center lg:items-start gap-4 lg:gap-6">
          <Logo />
          <p className="text-lg">
            Ứng dụng công nghệ vào quá trình tối ưu quản lý chung cư.
          </p>
      ...
      <div className="container border-t border-slate-700">
        <p className="capitalize pt-4 text-center lg:text-start">
          {`© ${currentYear} HomeLand, inc. all rights reserved.`}
        </p>
      </div>
      {/* Copyrights */}
    </footer>
